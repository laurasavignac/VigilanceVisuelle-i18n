...
export default {
  fr: {
    ...
    intro: `Le Laboratoire, seconde partie du site, permettra de manipuler la matière récoltée afin de repérer les questionnements qui s’en dégagent, d’approfondir leurs études et d’entrevoir des perspectives d’évolution. À terme, cette partie pourra donner lieu à des publications.
    <br>Cette partie sera active lorsqu’il y aura assez de contenu sur le site.
    <br>À très vite!`,
  },
  en: {
    title: `Laboratory`,
